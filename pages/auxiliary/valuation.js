...
Page({
  ...
  data: {
    ...
    products_type: ["奶粉专线(普通)", "奶粉专线(特殊)", "E特快", "CZ-EMS", "DHL优先包", "DHL经济包"],
    products_info:[
      { product_name: "奶粉专线(普通)", origin_price: "-", price: "-", tax_info: "包税", currency: "" },
      { product_name: "奶粉专线(特殊)", origin_price: "-", price: "-", tax_info: "包税", currency: "" },
      /*
      { product_name: "杂货包税专线", origin_price: "-", price: "-", tax_info: "按商品计税", currency: "" },
      */
      { product_name: "E特快", origin_price: "-", price: "-", tax_info: "包税", currency: "" },
      { product_name: "CZ-EMS", origin_price: "-", price: "-", tax_info: "海关抽检", currency: "" },
      { product_name: "DHL优先包", origin_price: "-", price: "-", tax_info: "海关抽检", currency: "" },
      { product_name: "DHL经济包", origin_price: "-", price: "-", tax_info: "海关抽检", currency: "" },
    ]
  },
